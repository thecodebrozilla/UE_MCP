...
void FSandboxPlatformFile::RegisterContentMountPath(const FString& InAssetPath, const FString& InFilesystemPath)
{
	...
	UE_CLOG(!bCreatedDirectory, LogFileSandbox, Error, TEXT("Failed to create sandboxed mount directory %ls for mount point %ls"),
...
void FSandboxPlatformFile::MigrateFileToSandbox(const FSandboxedPlatformFilePath& InPath) const
{
	...
	{
		UE_LOG(LogFileSandbox, Verbose, TEXT("MigrateFileToSandbox: Sandbox has the file %ls already at this location. Nothing to do."), *InPath.GetSandboxPath() );
	...
	{
		UE_LOG(LogFileSandbox, Verbose, TEXT("MigrateFileToSandbox: There is no file %ls at this location. Nothing to do."), *InPath.GetNonSandboxPath() );
		// Non-sandbox has no file at this location - nothing to do
		return;
	}

	UE_LOG(LogFileSandbox, Verbose, TEXT("MigrateFileToSandbox: Copying file %ls into the sandbox."), *InPath.GetNonSandboxPath() );
