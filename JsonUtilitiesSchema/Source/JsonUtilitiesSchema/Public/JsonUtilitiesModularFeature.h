...
public:
	...
	JSONUTILITIESSCHEMA_API static const FName Name;

	JSONUTILITIESSCHEMA_API IJsonUtilitiesModularFeature();
	virtual ~IJsonUtilitiesModularFeature() = default;
	
	JSONUTILITIESSCHEMA_API static IJsonUtilitiesModularFeature* Get();
