...
public:
	 ...
	 */
	JSONUTILITIESSCHEMA_API static const FStringView Delimiter;

	JSONUTILITIESSCHEMA_API FJsonSchemaMemberPath();
	JSONUTILITIESSCHEMA_API FJsonSchemaMemberPath(const FJsonSchemaMemberPath& InMemberPath);
	FJsonSchemaMemberPath(FJsonSchemaMemberPath&& Other) = default;
	JSONUTILITIESSCHEMA_API explicit FJsonSchemaMemberPath(FStringView InitialString);

	JSONUTILITIESSCHEMA_API FJsonSchemaMemberPath& operator=(const FJsonSchemaMemberPath& Other);
	 ...
	 * @return Success.
	 */
	JSONUTILITIESSCHEMA_API bool Push(FStringView String);
	 ...
	 * @return Success.
	 */
	JSONUTILITIESSCHEMA_API bool Pop(FStringView String);
	 ...
	 * @return Success.
	 */
	JSONUTILITIESSCHEMA_API bool PushSubmember(FStringView SubmemberString);
	 ...
	 * @return Success.
	 */
	JSONUTILITIESSCHEMA_API bool PopSubmember(FStringView SubmemberString);
