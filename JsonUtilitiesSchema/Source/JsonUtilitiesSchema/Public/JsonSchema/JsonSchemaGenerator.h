...
public:
	 ...
	 */
	JSONUTILITIESSCHEMA_API TSharedPtr<FJsonObject> static FPropertyToJsonSchemaObject(TNotNull<const FProperty*> Property,
	 ...
	 */
	JSONUTILITIESSCHEMA_API static FString FPropertyToJsonSchemaString(TNotNull<const FProperty*> Property,
		const FJsonSchemaPropertyFilter& PropertyFilter = FJsonSchemaPropertyFilter(), 
		const FJsonSchemaEditorMetadata* CachedEditorMetadata = nullptr,
	 ...
	 */
	JSONUTILITIESSCHEMA_API static TSharedPtr<FJsonObject> UStructToJsonSchemaObject(TNotNull<const UStruct*> Struct,
		const FJsonSchemaPropertyFilter& PropertyFilter = FJsonSchemaPropertyFilter(),
		const FJsonSchemaEditorMetadata* CachedEditorMetadata = nullptr,
		const void* InstanceMemory = nullptr);
	 ...
	 */
	JSONUTILITIESSCHEMA_API static FString UStructToJsonSchemaString(TNotNull<const UStruct*> Struct,
		const FJsonSchemaPropertyFilter& PropertyFilter = FJsonSchemaPropertyFilter(),
		const FJsonSchemaEditorMetadata* CachedEditorMetadata = nullptr,
		const int32 Indent = 0, const bool bPrettyPrint = true);
