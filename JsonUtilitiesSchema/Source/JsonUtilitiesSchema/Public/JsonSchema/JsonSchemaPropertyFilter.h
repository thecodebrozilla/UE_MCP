...
struct FJsonSchemaPropertyFilter
{
	...
	JSONUTILITIESSCHEMA_API explicit FJsonSchemaPropertyFilter(
	...
	JSONUTILITIESSCHEMA_API FJsonSchemaPropertyFilter(const FJsonSchemaPropertyFilter& Other);
	 ...
	 */
	JSONUTILITIESSCHEMA_API bool IsPropertyIgnored(TNotNull<const FProperty*> Property) const;
	 ...
	 */
	JSONUTILITIESSCHEMA_API bool IsPropertyMemberPathRequired(const FString& PropertyMemberPath) const;
	 ...
	 */
	JSONUTILITIESSCHEMA_API bool IsPropertyMemberPathSkipped(const FString& PropertyMemberPath) const;
	 ...
	 */
	JSONUTILITIESSCHEMA_API FString PropertyAuthoredNameToJsonKey(const FString& PropertyAuthoredName) const;
};
